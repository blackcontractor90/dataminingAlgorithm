...
class KnowledgeBase():
	def _init_(self,inputmap,names, variables, measurements):
...
class FourTuple():
	def _init_(self, a, b, alpha, beta):
		self.a = float(a)
		self.b = float(b)
...
class InputHandler():
	...
	def input(self):
        ...
        #global input values is populated
...
def main():
	print "Testing Fuzzy Rule with Data Point Cluster..."
	...
	#i changed the chrisp_value to crisp_value
	crisp_values = system.inference_engine()
	print system.defuzzifier(crisp_values)
